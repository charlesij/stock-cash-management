...
<div class="flex-1 px-6 bg-gray-100 relative">
    ...
    <form action="#" method="POST" class="bg-white shadow rounded-xl p-6">
        @csrf
        <div class="grid grid-cols-2 gap-4">
            <div class="mb-4">
                <label for="nama" class="block text-gray-700 font-semibold mb-2">Item Name</label>
            ...
            <div id="add_unit_modal" class="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 hidden">
                <div class="flex items-center justify-center min-h-screen p-4">
                    <div class="bg-white py-4 px-6 rounded-lg shadow-2xl w-full max-w-md">
                        ...
                        <form id="add_unit_form" class="px-6 py-4">
                            <div class="mb-4">
                                <label for="new_unit_name" class="block text-sm font-medium text-gray-700 mb-2">Unit Name</label>
