...
<div class="flex-1 px-6 bg-gray-100 relative">
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-gray-900">Add Customer</h1>
    </div>
    <form action="{{ route('customer.store') }}" method="POST" class="bg-white shadow rounded-xl p-6">
        @csrf

        <div class="mb-4">
            <label for="nama" class="block text-gray-700 font-semibold mb-2">Customer Name</label>
            <input type="text" name="nama" id="nama" value="{{ old('nama') }}" placeholder="Input Customer Name"
