...
<div class="mx-auto px-4 sm:px-6 lg:px-8">    
    <div class="flex space-between mb-4">
        <h2 class="text-lg font-semibold text-gray-900 title-table">Customer List</h2>
        <div class="flex ml-auto">
            ...
            <form action="{{ route('customer.edit') }}" method="POST" id="edit-form">
                @csrf
            ...
            <form action="{{ route('customer.delete') }}" method="POST" id="delete-form">
                @csrf
