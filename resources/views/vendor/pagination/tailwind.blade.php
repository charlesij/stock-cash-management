                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                   <span aria-current="page">
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-semibold bg-blue-600 text-white border border-blue-600 cursor-default leading-5 dark:bg-blue-700 dark:border-blue-700">
                                            {{ $page }}
                                        </span>
                                    </span>
                                @else
