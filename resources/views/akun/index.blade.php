        ...
        <div class="overflow-x-auto">
            <table class="min-w-full text-sm">
                <thead class="bg-gray-50 text-gray-600 uppercase text-xs">
                    <tr>
                        <th class="px-6 py-3 text-left w-[10%]">Kode Akun</th>
                        <th class="px-6 py-3 text-left w-[60%]">Nama Akun</th>
                        <th class="px-6 py-3 text-left w-[20%]">Kategori Akun</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    @foreach ($data as $item)
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-1 text-gray-500">{{ $item->akun->kode }}-{{ $item->kode }}</td>
